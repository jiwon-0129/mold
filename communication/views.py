...
def mypage1(request):
    ...
    logged_in_user_recommendation= Recommendation.objects.filter(author=request.user)
...
def mypage(request):
    ...
    return render(request, 'mypage.html', {'grades': logged_in_user_grades, 'meetings': logged_in_user_meetings, 'recommendations':logged_in_user_recommendation, 'attendances':logged_in_user_attendance})
